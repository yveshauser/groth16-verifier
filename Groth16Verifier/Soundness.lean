...
theorem verifyGroth16_no_false_positives
  ...
  by_contra h_true
  push_neg at h_true
  rw [Bool.eq_false_iff_ne_true] at h_true
  push_neg at h_true
  obtain ⟨witness, h_wit⟩ :=
    verifyGroth16_sound R1CS pd vk proof inputs h_wf (Bool.eq_true_of_ne_false h_true)
...
theorem verifyGroth16_iff_satisfiable
  ...
  · intro ⟨w, hw⟩
    exact Completeness.verifyGroth16_complete
      Prove pd R1CS vk inputs w hw h_wf
